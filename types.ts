...
export const INITIAL_ROADMAP: LevelData[] = [
  { 
    ...
    quiz: [
      { question: "ما هو الهدف الرئيسي من مرحلة اكتشاف العميل؟", options: ["بيع المنتج فوراً", "التحقق من صحة المشكلة والاحتياج", "جمع التمويل"], correctIndex: 1 },
      { question: "متى يعتبر العرض القيمي (Value Prop) ناجحاً؟", options: ["عندما يكون معقداً", "عندما يحل فجوة واضحة للعميل", "عندما يكون السعر هو الأرخص دائماً"], correctIndex: 1 }
    ]
  },
  { 
    id: 2, 
    ...
    quiz: [
      { question: "ما هو العنصر الأهم في مخطط نموذج العمل (BMC)؟", options: ["الشعار والهوية", "العلاقة مع العملاء والقيمة المضافة", "عدد الموظفين"], correctIndex: 1 },
      { question: "ما هي ميزة نموذج الاشتراكات (SaaS)؟", options: ["إيرادات متوقعة ومستمرة", "عدم الحاجة لتطوير المنتج", "سهولة الحصول على عملاء جدد بدون تسويق"], correctIndex: 0 }
    ]
  },
  { 
    id: 3, 
    ...
    quiz: [
      { question: "ماذا تعني كلمة MVP؟", options: ["المنتج الأكثر مبيعاً", "النسخة الأولية القابلة للتطبيق", "أفضل ميزات المنتج"], correctIndex: 1 },
      { question: "ما هو الهدف من خطة الاختبار الميداني؟", options: ["تحقيق أرباح ضخمة", "جمع التغذية الراجعة وتطوير الحل", "إيقاف المنافسين"], correctIndex: 1 }
    ]
  },
  { 
    id: 4, 
    ...
    quiz: [
      { question: "ما هو الـ TAM؟", options: ["إجمالي السوق المتاح", "السوق المستهدف فعلياً", "الأرباح السنوية المتوقعة"], correctIndex: 0 },
      { question: "لماذا نحلل المنافسين؟", options: ["لتقليدهم تماماً", "لتحديد ميزتنا التنافسية وتجنب أخطائهم", "لمعرفة أسعارهم فقط"], correctIndex: 1 }
    ]
  },
  { 
    id: 5, 
    ...
    quiz: [
      { question: "ماذا تعني 'نقطة التعادل' (Break-even Point)؟", options: ["عندما تتساوى الإيرادات مع المصاريف", "عندما ينسحب الشريك", "عندما يتوقف المشروع"], correctIndex: 0 },
      { question: "ما هو معدل الحرق (Burn Rate)؟", options: ["سرعة إنفاق السيولة المالية شهرياً", "معدل نمو العملاء", "تكلفة إنتاج الوحدة الواحدة"], correctIndex: 0 }
    ]
  },
  { 
    id: 6, 
    ...
    quiz: [
      { question: "ما هي أهم شريحة في العرض الاستثماري؟", options: ["شريحة الفريق والمشكلة والحل", "شريحة الألوان والتصميم", "شريحة أسماء المنافسين فقط"], correctIndex: 0 },
      { question: "ما هو الـ Term Sheet؟", options: ["عقد توظيف", "مذكرة شروط الاستثمار الأساسية", "فاتورة بيع"], correctIndex: 1 }
    ]
  }
];

// Fixed missing CONTACT property to resolve error in App.tsx line 84
